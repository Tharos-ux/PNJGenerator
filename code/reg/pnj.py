    ...
    def __init__(self,ld,current=None,change=None):
        ...
        match current:
            case None:
                ...
                self.name = t.Tools.gen_nom(self.sexe,ld)
                self.age = t.Tools.loi_normale(30,8)
                self.carac,self.constraints = t.Tools.fill_regexpr(ld,{'Nom' : self.name,'Age' : self.age, 'Sexe_biologique' : self.sexe})
                self.desc = ""
            case _:
                ...
                match change:
                    ...
                    case 'Nom':
                        # on reroll un nom
                        self.name = current.carac['Nom'] = t.Tools.gen_nom(self.sexe,ld,composed=True)
                    case 'Age':
                    ...
                    case car:
                        ...
                        while nextchar==current.carac[car]:
                            newchars = t.Tools.fill_regexpr(ld,current.carac.copy(),blacklist)[0]
                        ...
                        newchars,self.constraints = t.Tools.fill_regexpr(ld,{'Nom' : self.name,'Age' : self.age, 'Sexe_biologique' : self.sexe, change : current.carac[change]},blacklist)
                        charlist = t.Tools.fill_regexpr(ld,{'Nom' : self.name,'Age' : self.age, 'Sexe_biologique' : self.sexe, change : current.carac[change]},["Opener","CloserM","CloserF","Middle"])[0].keys()
                        print(charlist)
